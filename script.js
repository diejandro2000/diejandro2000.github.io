...
function generatePDF() {
  ...
  document.querySelectorAll("#invoiceItems tr").forEach(row => {
    ...
    if (horas > 10) {
      ...
      const extraTotal = extraHours * tarifaExtra;
      totalText = `+${extraTotal.toFixed(2)} € por ${extraHours.toFixed(2)} horas extra`;
    }
